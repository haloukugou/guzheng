<?php /*a:6:{s:47:"../template/default/cn/mobile/product\view.html";i:1554990134;s:45:"../template/default/cn/mobile/public\css.html";i:1551600893;s:46:"../template/default/cn/mobile/public\head.html";i:1553997495;s:49:"../template/default/cn/mobile/public\comment.html";i:1551599412;s:46:"../template/default/cn/mobile/public\foot.html";i:1551446328;s:51:"../template/default/cn/mobile/public\commentjs.html";i:1551599389;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
                ...
                <div class="col-md-12 mt-3">
                    <?php if(in_array('morecontents',$isdisplay_array)): ?>
                        <ul class="nav nav-tabs">
                            <li class="nav-item active"><a class="nav-link" href="#tab1" data-toggle="tab"><?php echo htmlentities(app('lang')->get('v_content1')); ?></a></li>
                        </ul>
                        <div class="tab-content detail">
                            <div id="tab1" class="tab-pane active"><?php echo $content1; ?></div>
                            <div id="tab2" class="tab-pane"><?php echo $rs['content2']; ?></div>
                            <div id="tab3" class="tab-pane"><?php echo $rs['content3']; ?></div>
                        </div>
                    <?php else: ?>
                        <ul class="nav nav-tabs"></ul>
                        <div class="tab-content detail"><?php echo $content1; ?></div>
                    <?php endif; ?>
...
<!--富文本编辑器结束--><?php endif; ?>
        ...
        <div class="col-md-3 d-none d-md-block">
            <aside>
                ...
                <!--分类 结束-->
                <!--相关产品 开始-->
                <h6 class="font-weight-bold"><i class="fa fa-dot-circle font-weight-light small"></i> <?php echo htmlentities(app('lang')->get('v_product_related')); ?></h6>
                <ul class="aside-list pl-0">
                    <?php $parentid = 0;$result = Db::name("product")->where("lang='$lang' and sortid in($sortidArr) and id<>$id and signid=1")->limit("5")->order("sequence desc")->select();$__LIST__ = $result; if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$relatedproRs): $mod = ($i % 2 );++$i;?>
...
const sku1 = new sku({
    ...
    fail(){
        $('#price').html("<?php echo htmlentities(app('lang')->get('v_no_price')); ?>");
        $('#stock').html(0);
    },
});
$(function(){
