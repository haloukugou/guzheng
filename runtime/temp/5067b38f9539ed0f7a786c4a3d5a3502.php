<?php /*a:6:{s:82:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\module\index.html";i:1554291637;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\head.html";i:1554291628;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\left.html";i:1554291637;s:88:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\global_left.html";i:1554291629;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\foot.html";i:1554291631;s:85:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\icheckjs.html";i:1543396364;}*/ ?>
<!--有理想的地方，地狱都是天堂-->
<!--Copyright @   版权所有-->
<!--开发：dj-->
<!DOCTYPE html>
                ...
                <?php if(app('config')->get('app.isdisplay.module') == '1'): ?>
                    <div class="box-header with-border">
                        <div class="col-md-12 mb-2">
                            <div class="row">
                                <a class="btn btn-success mb-2 mr-2" href="<?php echo url('module/index?lang='.input('lang')); ?>"><i class="fa fa-cubes"></i> <?php echo htmlentities(app('lang')->get('v_module')); ?> <?php echo htmlentities(app('lang')->get('v_manage')); ?></a>
                                <a class="btn btn-default mb-2" href="<?php echo url('module/edit?lang='.input('lang')); ?>"><i class="fa fa-plus-circle"></i> <?php echo htmlentities(app('lang')->get('v_add')); ?> <?php echo htmlentities(app('lang')->get('v_module')); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="box-body">
                    <table class="table table-striped table-bordered table-hover">
                        <form name="form2" id="form2" action="" method="post">
                            <tr>
                                <th>ID</th>
                                <th class="hidden-xs"><?php echo htmlentities(app('lang')->get('v_module_name')); ?></th>
                                <th><?php echo htmlentities(app('lang')->get('v_seo')); ?> <?php echo htmlentities(app('lang')->get('v_title')); ?></th>
                                <th class="hidden-xs"><?php echo htmlentities(app('lang')->get('v_keyword')); ?></th>
                                <th class="hidden-xs"><?php echo htmlentities(app('lang')->get('v_description')); ?></th>
                                <?php if(app('config')->get('app.isdisplay.module') == '1'): ?>
                                    <th><?php echo htmlentities(app('lang')->get('v_status')); ?></th>
                                <?php endif; ?>
                            ...
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                                ...
                                <tr>
                                    <td><label><?php if($rs['id'] > '10'): ?><input type="checkbox" name="selectid[]" id="selectid" value="<?php echo htmlentities($rs['id']); ?>" /><?php endif; ?><span class="hidden-xs"> <?php echo htmlentities($rs['id']); ?></span></label></td>
                                    <td class="hidden-xs"><?php echo htmlentities($rs['title']); ?></td>
                                    <td>
                                        <input name="seotitle[]" type="text" value="<?php echo htmlentities($rs['seotitle']); ?>" class="form-control" />
                                    </td>
                                    <td class="hidden-xs"><input name="keyword[]" type="text" value="<?php echo htmlentities($rs['keyword']); ?>" class="form-control" /></td>
                                    <td class="hidden-xs"><input name="description[]" type="text" value="<?php echo htmlentities($rs['description']); ?>" class="form-control" /></td>
                                    <?php if(app('config')->get('app.isdisplay.module') == '1'): ?>
                                    <td>
                                        <?php if($rs['disabled'] == '1'): ?>
                                            <a class="btn btn-sm btn-info" onClick='return confirm("<?php echo htmlentities(app('lang')->get('v_enable_cancel')); ?>？");' href="<?php echo url('module/update_disabled?value=0&id='.$rs['id']); ?>"><?php echo htmlentities(app('lang')->get('v_enable')); ?></a>
                                        <?php else: ?>
                                            <a class="btn btn-sm btn-danger" onClick='return confirm("<?php echo htmlentities(app('lang')->get('v_enable_makesure')); ?>？");' href="<?php echo url('module/update_disabled?value=1&id='.$rs['id']); ?>"><?php echo htmlentities(app('lang')->get('v_disable')); ?></a>
                                        <?php endif; ?>
                                    </td>
                                    <?php endif; ?>
                                    <td>
                                        <a href="<?php echo url('module/edit?lang='.input('lang').'&id='.$rs['id']); ?>" class="btn btn-sm btn-success mb-2 mr-2"><i class="fa fa-edit"></i> <?php echo htmlentities(app('lang')->get('v_edit')); ?></a>
                                        <?php if(app('config')->get('app.isdisplay.module') == '1'): if($rs['id'] < '11'): ?>
                                            ...
                                            <?php else: ?>
                                                <a class="btn btn-sm btn-danger mb-2" onClick='return confirm("<?php echo htmlentities(app('lang')->get('v_confirm_delete')); ?>！");' href="<?php echo url('module/delete_one?lang='.input('lang').'&id='.$rs['id']); ?>"><?php echo htmlentities(app('lang')->get('v_delete')); ?></a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            ...
                            <tr>
                                <?php if(app('config')->get('app.isdisplay.module') == '1'): ?>
                                    <td colspan="7">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12 mt-2"><div class="pull-left"><?php echo $list->render(); ?></div><div class="pull-left"><?php echo htmlentities(app('lang')->get('v_total')); ?> <?php echo htmlentities($lastPage); ?> <?php echo htmlentities(app('lang')->get('v_page')); ?> <?php echo htmlentities($total); ?> <?php echo htmlentities(app('lang')->get('v_records')); ?></div></div>
                                            <div class="col-md-6 col-xs-12">
                                                <div class="pull-right">
                                                    ...
                                                    <button type="button" class="btn btn-success mt-2 mb-2 mr-2" onClick='ConfirmDel("","<?php echo url('module/update_all?lang='.input('lang')); ?>","update");'><i class="fa fa-arrow-circle-o-up"></i> <?php echo htmlentities(app('lang')->get('v_batch')); ?> <?php echo htmlentities(app('lang')->get('v_update')); ?></button>
                                                    <button type="button" class="btn btn-danger mt-2 mb-2" onClick='ConfirmDel("<?php echo htmlentities(app('lang')->get('v_confirm_delete')); ?>！","<?php echo url('module/delete_all?lang='.input('lang')); ?>","delete");'><i class="fa fa-trash"></i> <?php echo htmlentities(app('lang')->get('v_delete_select')); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                <?php else: ?>
                                    <td colspan="7">
                                        <div class="pull-right"><button type="button" class="btn btn-success" onClick='ConfirmDel("","<?php echo url('module/update_all?lang='.input('lang')); ?>","update");'><i class="fa fa-arrow-circle-o-up"></i> <?php echo htmlentities(app('lang')->get('v_batch')); ?> <?php echo htmlentities(app('lang')->get('v_update')); ?></button></div>
                                    </td>
                                <?php endif; ?>
                            </tr>
                        </form>
