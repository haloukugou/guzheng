<?php /*a:6:{s:80:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\sort\index.html";i:1554291626;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\head.html";i:1554291628;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\left.html";i:1554291637;s:88:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\global_left.html";i:1554291629;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\foot.html";i:1554291631;s:85:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\icheckjs.html";i:1543396364;}*/ ?>
<!--有理想的地方，地狱都是天堂-->
<!--Copyright @   版权所有-->
<!--开发：dj-->
<!DOCTYPE html>
                ...
                <div class="box-header with-border">
                    <form name="form1" action="" method="post">
                        ...
                        <div class="col-md-8 mb-2">
                            <div class="row">
                                <a class="btn btn-success mb-2 mr-4" href="<?php echo url('sort/index?tabledir='.$tabledir.'&lang='.input('lang')); ?>"><i class="fa fa-sitemap"></i> <?php echo htmlentities(app('lang')->get('v_sort')); ?> <?php echo htmlentities(app('lang')->get('v_manage')); ?></a>
                                <a class="btn btn-default mb-2" href="<?php echo url('sort/edit?tabledir='.$tabledir.'&lang='.input('lang')); ?>"><i class="fa fa-plus-circle"></i> <?php echo htmlentities(app('lang')->get('v_add')); ?> <?php echo htmlentities(app('lang')->get('v_sort')); ?></a>
                            </div>
                        </div>
                        ...
                        <form name="form2" id="form2" action="" method="post">
                            ...
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <?php if(!in_array(($rs['id']), is_array($navModuleRs['no_delete_sortid'])?$navModuleRs['no_delete_sortid']:explode(',',$navModuleRs['no_delete_sortid']))): ?>
                                    ...
                                    <td>
                                        <a href="<?php echo url('sort/edit?tabledir='.$rs['tabledir'].'&id='.$rs['id'].'&lang='.input('lang')); ?>" class="btn btn-success btn-sm mr-2 mb-2"><i class="fa fa-edit"></i> <?php echo htmlentities(app('lang')->get('v_edit')); ?></a>
                                        <?php if(in_array(($rs['id']), is_array($navModuleRs['no_delete_sortid'])?$navModuleRs['no_delete_sortid']:explode(',',$navModuleRs['no_delete_sortid']))): ?>
                                        ...
                                        <?php else: ?>
                                            <a class="btn btn-danger btn-sm mb-2" onClick='return confirm("<?php echo htmlentities(app('lang')->get('v_confirm_delete')); ?>！");' href="<?php echo url('sort/delete_one?lang='.input('lang').'&id='.$rs['id'].'&tabledir='.$rs['tabledir']); ?>"><i class="fa fa-trash"></i> <?php echo htmlentities(app('lang')->get('v_delete')); ?></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <tr>
                                <td colspan="4">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12 mt-2"><div class="pull-left mt-2"><?php echo htmlentities(app('lang')->get('v_total')); ?> <?php echo htmlentities($total); ?> <?php echo htmlentities(app('lang')->get('v_records')); ?></div></div>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="pull-right">
                                                ...
                                                <button type="button" class="btn btn-success mt-2 mb-2 mr-2 hidden-xs" onClick='ConfirmDel("","<?php echo url('sort/update_all?lang='.input('lang')); ?>","update");'><i class="fa fa-arrow-circle-o-up"></i> <?php echo htmlentities(app('lang')->get('v_batch')); ?> <?php echo htmlentities(app('lang')->get('v_update')); ?></button>
                                                <button type="button" class="btn btn-danger mt-2 mb-2" onClick='ConfirmDel("<?php echo htmlentities(app('lang')->get('v_confirm_delete')); ?>！","<?php echo url('sort/delete_all?lang='.input('lang').'&tabledir='.$tabledir); ?>","delete");'><i class="fa fa-trash"></i> <?php echo htmlentities(app('lang')->get('v_delete_select')); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </td>
