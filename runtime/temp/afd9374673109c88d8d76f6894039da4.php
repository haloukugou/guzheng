<?php /*a:5:{s:79:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\sort\edit.html";i:1554291630;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\head.html";i:1554291628;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\left.html";i:1554291637;s:88:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\global_left.html";i:1554291629;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\foot.html";i:1554291631;}*/ ?>
<!--有理想的地方，地狱都是天堂-->
<!--Copyright @   版权所有-->
<!--开发：dj-->
<!DOCTYPE html>
    ...
    <div class="content-wrapper">
        ...
        <div>
            <ol class="breadcrumb">
                ...
                <li><?php echo htmlentities($navModuleRs['title']); ?> <?php echo htmlentities(app('lang')->get('v_manage')); ?></li>
                <li><?php echo htmlentities($navModuleRs['title']); ?> <?php echo htmlentities(app('lang')->get('v_sort')); ?></li>
                <li><?php if(empty($rs['id']) || (($rs['id'] instanceof \think\Collection || $rs['id'] instanceof \think\Paginator ) && $rs['id']->isEmpty())): ?><?php echo htmlentities(app('lang')->get('v_add')); else: ?><?php echo htmlentities(app('lang')->get('v_edit')); ?><?php endif; ?> <?php echo htmlentities(app('lang')->get('v_sort')); ?></li>
            </ol>
        </div>
        <!--导航 结束-->
        <!--内容 开始-->
        <section class="content">
            <div class="box">
                <div class="box-body">
                    <form name="form1" action="<?php echo url('sort/index?tabledir='.$tabledir.'&lang='.input('lang')); ?>" method="post">
                        <input type="hidden" name="lang" value="<?php echo input('lang'); ?>">
                        <input type="hidden" name="tabledir" value="<?php echo input('tabledir'); ?>">
                        <div class="col-md-8">
                            <div class="row">
                                <a class="btn btn-default mb-2 mr-4" href="<?php echo url('sort/index?tabledir='.$tabledir.'&lang='.input('lang')); ?>"><i class="fa fa-sitemap"></i> <?php echo htmlentities(app('lang')->get('v_sort')); ?> <?php echo htmlentities(app('lang')->get('v_manage')); ?></a>
                                <a class="btn btn-success mb-2" href="<?php echo url('sort/edit?tabledir='.$tabledir.'&lang='.input('lang')); ?>"><i class="fa fa-plus-circle"></i> <?php echo htmlentities(app('lang')->get('v_add')); ?> <?php echo htmlentities(app('lang')->get('v_sort')); ?></a>
                            </div>
                        </div>
            ...
            <div class="box box-success">
                <div class="box-header with-border"><i class="fa fa-edit"></i> <?php if(empty($rs['id']) || (($rs['id'] instanceof \think\Collection || $rs['id'] instanceof \think\Paginator ) && $rs['id']->isEmpty())): ?><?php echo htmlentities(app('lang')->get('v_add')); else: ?><?php echo htmlentities(app('lang')->get('v_edit')); ?><?php endif; ?> <?php echo htmlentities(app('lang')->get('v_sort')); ?></div>
                <div class="box-body">
                    <form name="editform" id="editform" method="post" action="" class="form-horizontal">
                        ...
                        <input type="hidden" name="routesign" value="<?php echo htmlentities($routesign); ?>">
                        <input type="hidden" name="lang" value="<?php echo input('lang'); ?>">
                        ...
                        <?php if(in_array('sortimg',$isdisplay_array)): ?>
                            <div class="form-group">
                                <div class="col-md-3 control-label"><?php echo htmlentities(app('lang')->get('v_img')); ?></div>
                                <div class="col-md-5">
                                    <div class="input-group"><input name="thumb" id="morepics1" type="text" class="form-control" value="<?php echo htmlentities($rs['thumb']); ?>" /> <span class="input-group-btn"><button type="button" class="btn btn-success" onclick="upImage1();"><i class="fa fa-cloud-upload"></i> <?php echo htmlentities(app('lang')->get('v_upload_img')); ?></button></span></div>
                                </div>
                            </div>
                        <?php endif; ?>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <textarea name="description" class="form-control" rows="4"><?php echo htmlentities($rs['description']); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <select name="parentid" class="form-control">
                                    <option><?php echo htmlentities(app('lang')->get('v_top_sort')); ?></option>
                                    <?php if(is_array($sort) || $sort instanceof \think\Collection || $sort instanceof \think\Paginator): if( count($sort)==0 ) : echo "" ;else: foreach($sort as $key=>$v): if($v['id'] != $rs['id']): ?>
                        ...
                        <div class="form-group">
                            <div class="col-md-3 control-label"><?php echo htmlentities(app('lang')->get('v_urlroute')); ?> <span class="text-red inline">*</span></div>
                            <div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" name="sequence" value="<?php if(empty($rs['sequence']) || (($rs['sequence'] instanceof \think\Collection || $rs['sequence'] instanceof \think\Paginator ) && $rs['sequence']->isEmpty())): ?>0<?php else: ?><?php echo htmlentities($rs['sequence']); ?><?php endif; ?>" />
                            </div>
                        </div>
                        <?php if(in_array('index_template',$isdisplay_array)): ?>
                        <div class="form-group">
                            <div class="col-md-3 control-label"><?php echo htmlentities(app('lang')->get('v_index_listemplate')); ?></div>
                            <div class="col-md-5">
                                <select name="listtemp" class="form-control">
                                    <?php foreach($listtemp as $listtempRs): $listtempPrefix = strstr($listtempRs,'.html',true); if(empty($rs['id']) and $listtempPrefix == $defaulttemp): ?>
                                            <option value="<?php echo htmlentities($defaulttemp); ?>" selected="selected"><?php echo htmlentities($listtempRs); ?></option>
                                        <?php else: ?>
                                            <option value="<?php echo htmlentities($listtempPrefix); ?>" <?php if($rs['listtemp'] == $listtempPrefix): ?>selected="selected"<?php endif; ?>><?php echo htmlentities($listtempRs); ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </select>
                            </div>
