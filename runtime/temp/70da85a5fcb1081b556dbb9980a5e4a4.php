<?php /*a:6:{s:85:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\attribute\index.html";i:1554291630;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\head.html";i:1554291628;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\left.html";i:1554291637;s:88:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\global_left.html";i:1554291629;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\foot.html";i:1554291631;s:85:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\icheckjs.html";i:1543396364;}*/ ?>
<!--有理想的地方，地狱都是天堂-->
<!--Copyright @   版权所有-->
<!--开发：dj-->
<!DOCTYPE html>
    ...
    <div class="content-wrapper">
        ...
        <div>
            <ol class="breadcrumb">
                ...
                <li><?php echo htmlentities($navModuleRs['title']); ?> <?php echo htmlentities(app('lang')->get('v_attribute')); ?></li>
            </ol>
        </div>
        <!--导航 结束-->
        <!--内容 开始-->
                ...
                <div class="box-header with-border">
                    <form name="form1" action="" method="post">
                        ...
                        <div class="col-md-8 mb-2">
                            <div class="row">
                                <a class="btn btn-success mb-2 mr-4" href="<?php echo url('attribute/index?tabledir='.input('tabledir').'&lang='.input('lang')); ?>"><i class="fa fa-tag"></i> <?php echo htmlentities(app('lang')->get('v_attribute')); ?> <?php echo htmlentities(app('lang')->get('v_manage')); ?></a>
                                <a class="btn btn-default mb-2" href="<?php echo url('attribute/edit?tabledir='.input('tabledir').'&lang='.input('lang')); ?>"><i class="fa fa-plus-circle"></i> <?php echo htmlentities(app('lang')->get('v_add')); ?> <?php echo htmlentities(app('lang')->get('v_attribute')); ?></a>
                            </div>
                        </div>
                ...
                <div class="box-body">
                    <table class="table table-striped table-bordered table-hover">
                        <form name="form2" id="form2" action="" method="post">
                            <tr>
                                <th>ID</th>
                                <th><?php echo htmlentities(app('lang')->get('v_type')); ?></th>
                            ...
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-sm mb-2 mr-2" href="<?php echo url('attribute/edit?id='.$rs['id'].'&tabledir='.input('tabledir').'&lang='.input('lang')); ?>"><i class="fa fa-edit"></i> <?php echo htmlentities(app('lang')->get('v_edit')); ?></a>
                                        <a class="btn btn-danger btn-sm mb-2" onClick='return confirm("<?php echo htmlentities(app('lang')->get('v_confirm_delete')); ?>！");' href="<?php echo url('attribute/delete_one?lang='.input('lang').'&id='.$rs['id']); ?>"><i class="fa fa-trash"></i> <?php echo htmlentities(app('lang')->get('v_delete')); ?></a>
                                    </td>
                                </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <tr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="pull-right">
                                                ...
                                                <button type="button" class="btn btn-success mt-2 mb-2 mr-2" onClick='ConfirmDel("","<?php echo url('attribute/update_all?lang='.input('lang')); ?>","update");'><i class="fa fa-arrow-circle-o-up"></i> <?php echo htmlentities(app('lang')->get('v_batch')); ?> <?php echo htmlentities(app('lang')->get('v_update')); ?></button>
                                                <button type="button" class="btn btn-danger mt-2 mb-2" onClick='ConfirmDel("<?php echo htmlentities(app('lang')->get('v_confirm_delete')); ?>！","<?php echo url('attribute/delete_all?lang='.input('lang')); ?>","delete");'><i class="fa fa-trash"></i> <?php echo htmlentities(app('lang')->get('v_delete_select')); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </td>
