<?php /*a:4:{s:48:"../template/default/cn/mobile/product\index.html";i:1554990026;s:45:"../template/default/cn/mobile/public\css.html";i:1551600893;s:46:"../template/default/cn/mobile/public\head.html";i:1553997495;s:46:"../template/default/cn/mobile/public\foot.html";i:1551446328;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 pt-2">
                ...
                <a href="<?php echo htmlentities($module_path); ?>" class="ml-2"><?php echo htmlentities(app('lang')->get('v_product')); ?></a>
            ...
            <div class="col-md-4 mt-2">
                <!--<form name="search_form" method="post" action="" onsubmit="return checksearch('<?php echo url('product/index'); ?>');">-->
...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-md-3 d-none d-md-block">
            <aside>
                <!--分类 开始-->
                <h6 class="font-weight-bold"><i class="fa fa-dot-circle font-weight-light small"></i> <?php echo htmlentities(app('lang')->get('v_product_sort')); ?></h6>
                <ul class="nav nav-list flex-column mb-4">
                    <li><a class="<?php if(empty(input('sortid'))): ?>active<?php endif; ?>" href="<?php echo htmlentities($module_path); ?>"><?php echo htmlentities(app('lang')->get('v_product_all')); ?></a></li>
                ...
                <!--分类 结束-->
                <!--热门产品 开始-->
                <h6 class="font-weight-bold"><i class="fa fa-dot-circle font-weight-light small"></i> <?php echo htmlentities(app('lang')->get('v_product_hot')); ?></h6>
                <ul class="aside-list pl-0">
                    <?php $parentid = 0;$result = Db::name("product")->where("lang='$lang' and signid=1")->limit("5")->order("hits desc")->select();$__LIST__ = $result; if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hotproRs): $mod = ($i % 2 );++$i;?>
                    <li class="max-height-50">
                        <a href="<?php echo url($lang_path.$hotproRs['urlroute'].'-'.$hotproRs['routesign'].$hotproRs['id']); ?>">
                            <img alt="<?php echo htmlentities($hotproRs['title']); ?>" width="60" class="float-left img-fluid rounded mr-2 mt-1" src="<?php echo htmlentities($hotproRs['thumb']); ?>" onerror="this.src='/skin/admin/img/nopic.png'">
                            <?php echo htmlentities($hotproRs['title']); ?><br><span class="text-muted"><?php echo msubstr($hotproRs['description'],0,52); ?></span>
                        </a>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
