<?php /*a:6:{s:80:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\spec\index.html";i:1554291629;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\head.html";i:1554291628;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\left.html";i:1554291637;s:88:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\global_left.html";i:1554291629;s:81:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\foot.html";i:1554291631;s:85:"D:\phpStudy\PHPTutorial\WWW\5bb1cc23560bb\application\admin\view\public\icheckjs.html";i:1543396364;}*/ ?>
<!--有理想的地方，地狱都是天堂-->
<!--Copyright @   版权所有-->
<!--开发：dj-->
<!DOCTYPE html>
    ...
    <div class="content-wrapper">
        ...
        <div>
            <ol class="breadcrumb">
                ...
                <li><?php echo htmlentities($navModuleRs['title']); ?> <?php echo htmlentities(app('lang')->get('v_spec')); ?></li>
            </ol>
        </div>
        <!--导航 结束-->
        <!--内容 开始-->
                ...
                <div class="box-header with-border">
                    <form name="form1" action="" method="post">
                        ...
                        <div class="col-md-8 mb-2">
                            <div class="row">
                                <a class="btn btn-success mb-2 mr-2" href="<?php echo url('spec/index?tabledir='.input('tabledir').'&lang='.input('lang')); ?>"><i class="fa fa-puzzle-piece"></i> <?php echo htmlentities(app('lang')->get('v_spec')); ?> <?php echo htmlentities(app('lang')->get('v_manage')); ?></a>
                                <a class="btn btn-default mb-2 mr-2" href="<?php echo url('spec/edit?tabledir='.input('tabledir').'&lang='.input('lang')); ?>"><i class="fa fa-edit"></i> <?php echo htmlentities(app('lang')->get('v_add')); ?> <?php echo htmlentities(app('lang')->get('v_spec')); ?></a>
                                <a class="btn btn-default mb-2 mr-2" href="<?php echo url('attribute/index?tabledir='.input('tabledir').'&lang='.input('lang').'&moduletable=Spec'); ?>"><i class="fa fa-tag"></i> <?php echo htmlentities(app('lang')->get('v_spec')); ?> <?php echo htmlentities(app('lang')->get('v_attribute')); ?></a>
                                <a class="btn btn-default mb-2" href="<?php echo url('attribute/edit?tabledir='.input('tabledir').'&lang='.input('lang').'&moduletable=Spec'); ?>"><i class="fa fa-edit"></i> <?php echo htmlentities(app('lang')->get('v_add')); ?> <?php echo htmlentities(app('lang')->get('v_attribute')); ?></a>
                            </div>
                        </div>
                ...
                <div class="box-body">
                    <table class="table table-striped table-bordered table-hover">
                        <form name="form2" id="form2" action="" method="post">
                            <tr>
                                <th>ID</th>
                                <th class="hidden-xs"><?php echo htmlentities(app('lang')->get('v_attribute')); ?></th>
                            ...
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                                ...
                                <tr>
                                    <td><label><input type="checkbox" name="selectid[]" id="selectid" value="<?php echo htmlentities($rs['id']); ?>" /> <?php echo htmlentities($rs['id']); ?></label></td>
                                    <td class="hidden-xs"><?php echo htmlentities($rs['att_title']); ?></td>
                                    <td><input name="title[]" type="text" value="<?php echo htmlentities($rs['title']); ?>" class="form-control" /></td>
                                    <td class="hidden-xs"><input name="sequence[]" type="text" value="<?php echo htmlentities($rs['sequence']); ?>" class="form-control" /></td>
                                    <td>
                                        <a href="<?php echo url('spec/edit?id='.$rs['id'].'&tabledir='.input('tabledir').'&lang='.input('lang')); ?>" class="btn btn-success btn-sm mb-2 mr-2"><i class="fa fa-edit"></i> <?php echo htmlentities(app('lang')->get('v_edit')); ?></a>
                                        <a class="btn btn-sm btn-danger mb-2" onClick='return confirm("<?php echo htmlentities(app('lang')->get('v_confirm_delete')); ?>！");' href="<?php echo url('spec/delete_one?lang='.input('lang').'&id='.$rs['id']); ?>"><i class="fa fa-trash"></i> <?php echo htmlentities(app('lang')->get('v_delete')); ?></a>
                                    </td>
                                </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <tr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="pull-right">
                                                ...
                                                <button type="button" class="btn btn-success mt-2 mb-2 mr-2" onClick='ConfirmDel("","<?php echo url('spec/update_all?lang='.input('lang')); ?>","update");'><i class="fa fa-arrow-circle-o-up"></i> <?php echo htmlentities(app('lang')->get('v_batch')); ?> <?php echo htmlentities(app('lang')->get('v_update')); ?></button>
                                                <button type="button" class="btn btn-danger mt-2 mb-2" onClick='ConfirmDel("<?php echo htmlentities(app('lang')->get('v_confirm_delete')); ?>！","<?php echo url('spec/delete_all?lang='.input('lang')); ?>","delete");'><i class="fa fa-trash"></i> <?php echo htmlentities(app('lang')->get('v_delete_select')); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </td>
