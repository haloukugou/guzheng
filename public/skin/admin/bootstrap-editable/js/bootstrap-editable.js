...
(function ($) {
    ...
    */      
    ...
    '<div><div class="editable-input mb-2"></div><div class="editable-buttons"></div></div>'+
...
(function ($) {
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-info mr-2 editable-submit"><i class="fa fa-check"></i></button>'+
                                '<button type="button" class="btn btn-default editable-cancel"><i class="fa fa-times"></i></button>';         
